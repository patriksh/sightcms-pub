{{-- Backpack admin panel checklist dependency field - modified to work with MongoDB morphs. --}}
        ...
        //get entity with relations for primary dependency
          ...
          if ($old_primary_dependency) {
              ...
              foreach ($primary_array as $primary_item) {
                  foreach ($primary_item[rtrim($secondary_dependency['entity'], 's') . '_id'] as $second_item) {
                      $secondary_ids[$second_item] = $second_item;
                  }
              }
          }
