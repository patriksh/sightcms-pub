...
class GastroCategoryCrudController extends CrudController
{
    use ListOperation;
    use CreateOperation;
    use UpdateOperation;
    ...
    {
        $this->crud->setModel(\App\Models\GastroCategory::class);
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/gastro-category');
        $this->crud->setEntityNameStrings(__('gastro category'), __('gastro categories'));
